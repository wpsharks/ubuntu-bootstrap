...
# NOTE: The next time I build this I should create users `nobody` and `app` in the base, so that it's possible
# to mount shared volumes owned by those users/groups without any problem. See: `Vagrantfile` mounts.
